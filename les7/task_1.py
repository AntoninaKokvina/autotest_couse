...
class Segment:
    def __init__(self, a, b):
        """
        :param a, b: кортежb с координатами точек (x1, y1), (x2, y2)
        """
    ...
    def length(self):
        ...
        l = round(((self.dot_a[0] - self.dot_b[0]) ** 2 + (self.dot_a[1] - self.dot_b[1]) ** 2) ** 0.5, 2)
        print(self.dot_a, self.dot_b, l)
        return l
    ...
    def x_axis_intersection(self):
        ...
        return True if self.dot_a[1] * self.dot_b[1] < 0 else False
