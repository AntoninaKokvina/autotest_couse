...
def letter_stat(our_str):
    """
    функция подсчитывает количество вхождений каждой буквы в строке
    :param our_str: исходная строка для подсчета
    ...
    # считаем количество вхождений символа, к-й стоит в начале списка
